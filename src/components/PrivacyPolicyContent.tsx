...
const PrivacyPolicyContent: React.FC = () => {
  return (
    <div className="overflow-y-auto xs:h-[42vh] lg:h-[43vh] px-5">
      ...
      <p>
        At Samitra, accessible from https://samitra.katitb22.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Samitra and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Samitra. This policy is not applicable to any
      ...
      <p>
        Samitra follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Samitra uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertising partners of Samitra.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Samitra, which are sent directly
      ...
      <p>
        Note that Samitra has no access to or control over these cookies that
      ...
      <p>
        Samitra does not knowingly collect any Personal Identifiable Information
