  ...
  return (
    <div className='flex w-full bg-primaryOrange justify-center items-center'>
      <svg height="50" width="60">
        <circle cx="25" cy="25" r="24" stroke="#C6DD68" stroke-width="2.5" fill="#C6DD68" />
        <text className={`font-magilio text-subHeading`} x="42%" y="50%" text-anchor="middle" dy=".3em">{numUsers}</text>
      </svg> 
