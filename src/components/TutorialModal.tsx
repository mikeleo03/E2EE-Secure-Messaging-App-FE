          ...
          <div className="flex flex-col items-center justify-center gap-5">
            ...
            <div>
              <CaptionCard
                ...
                className={`font-alegreyasans xs:text-body md:text-subHeading items-center px-10 h-[80px] xs:w-[280px] xs:h-[50px] md:w-[700px]`}
              />
            </div>
            <div>
              <CaptionCard
            ...
            <div>
              <CaptionCard
                ...
                className={`font-alegreyasans xs:text-body md:text-subHeading flex items-center px-10 xs:w-[280px] xs:h-[80px] md:w-[700px] md:h-[80px]`}
              />
            </div>
            <div>
              <CaptionCard
                text="5. if there is a match found, you will be redirected to the chat room with your matching person."
                className={`font-alegreyasans xs:text-body md:text-subHeading flex items-center px-10 xs:w-[280px] md:w-[700px] h-[80px]`}
              />
            </div>
            <div>
              <CaptionCard
                text="6. Click Reveal My Name button together to reveal name."
                className={`font-alegreyasans xs:text-body md:text-subHeading flex items-center px-10 xs:w-[280px] md:w-[700px] h-[50px]`}
              />
            </div>
            <div>
              <CaptionCard
